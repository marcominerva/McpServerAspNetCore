...
public class WeatherTools
{
    ...
    {
        logger?.LogInformation("User {User} is requesting a {Days}-day weather forecast for city: {City} with units: {Units} and language: {Language}", user?.Identity?.Name ?? "Unknown", days, city, units, language);
